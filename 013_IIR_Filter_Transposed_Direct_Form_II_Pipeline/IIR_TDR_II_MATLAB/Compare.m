...
file_Input_Signal1 = fopen('\Examples\31_IIR_Filter_Transposed_Direct_Form_II_Pipeline\IIR_TDR_II_MATLAB\Output_Vec.txt','w');
...
file_Output_Signal_1 = fopen('\Examples\31_IIR_Filter_Transposed_Direct_Form_II_Pipeline\IIR_TDR_II_MATLAB\Output_Vec.txt');
Output_Vec_Sig = fscanf(file_Output_Signal_1 , '%d');
fclose(file_Output_Signal_1);

file_Output_Signal_2 = fopen('\Examples\31_IIR_Filter_Transposed_Direct_Form_II_Pipeline\IIR_TDR_II_MATLAB\Output_Vec_HDL.txt');
