...
file_Input_Signal1 = fopen('\Examples\20_FIR_Filter_Direct_Form\FIR_Direct_Form_MATLAB\Output_Vec.txt','w');
...
file_Output_Signal_1 = fopen('\Examples\20_FIR_Filter_Direct_Form\FIR_Direct_Form_MATLAB\Output_Vec.txt');
Output_Vec_Sig = fscanf(file_Output_Signal_1 , '%d');
fclose(file_Output_Signal_1);

file_Output_Signal_2 = fopen('\Examples\20_FIR_Filter_Direct_Form\FIR_Direct_Form_MATLAB\Output_Vec_HDL.txt');
